...
- Remote runtime now launches through a login shell, so it inherits your full PATH (e.g. `~/.local/bin`, nvm) and can discover locally-installed agents like Claude Code
